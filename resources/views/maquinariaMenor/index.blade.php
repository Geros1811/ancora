...
<div class="container" style="max-width: 1200px; margin: 20px auto; padding: 20px; background: #ffffff; border-radius: 10px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1);">
    ...
    <!-- Información general de maquinaria menor -->
    ...
    <div class="table-container" style="margin-top: 20px;">
        ...
        <form action="{{ route('maquinariaMenor.store', ['obraId' => $obraId]) }}" method="POST">
            @csrf
...
<script>
    ...
    function updateTotal() {
        ...
        fetch(`{{ route('updateCostoDirecto', ['obraId' => $obraId, 'costo' => 'maquinariaMenor']) }}?costo=${total.toFixed(2)}`, {
            method: 'POST',
            headers: {
