    ...
    <div class="table-container" style="margin-top: 20px;">
        ...
        <form action="{{ route('comidas.store', ['obraId' => $obraId]) }}" method="POST" enctype="multipart/form-data">
            ...
            @if(Auth::check() && Auth::user()->role != 'maestro_obra' && Auth::user()->role != 'residente' && Auth::user()->hasRole('arquitecto'))
                ...
                <a href="{{ route('comidas.pdf', ['obraId' => $obraId]) }}" class="btn btn-primary" style="margin-top: 10px; margin-left: 10px;" target="_blank">
...
<script>
    ...
    function removeRow(button) {
        ...
        fetch(`/comidas/{{ $obraId }}/detalles/${detalleId}`, {
            method: 'POST',
            headers: {
